...
![Agent configuration for containers running on MesosContainerizer and Docker once the VxLAN has been configured.](dcos-docs/1.8/overview/design/img/overlay-fig-1.pmg)
...
![Software architecture for DC/OS overlay control plane.](dcos-docs/1.8/overview/design/img/overlay-fig-2.pmg)
